public interface FurnitureFactory {
  ...
  public static void main(String[] args) {
    ...
    int a = 200;
    Fruniture furniture = null; // grandparent
...
//抽離static method -> factory pattern 做緊polymorphism
  static FurnitureFactory createFactory(Style style) { // return type need tobe a interface -> polymorphism
